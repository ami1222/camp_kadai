...
$stmt = $pdo->prepare("SELECT * FROM coffee_table");
$status = $stmt->execute();
...
if($status==false){
  ...
  while( $res = $stmt->fetch(PDO::FETCH_ASSOC)){
      ...
      $view .= "<p id='update'>";
      $view .= '<a href="view_coffee.php?id='.$res["id"].'">';
      $view .= $res["Indate"];
      $view .= "更新";
      $view .= '</a>';
      $view .= "</p>";
